...
async def startup():
    ...
    indexes = [
        ...
        ("paper_margin_blocks", "position_id", {"unique": True}),
        ...
        ("signal_audits", [ ("signal_id", 1), ("recorded_at", 1) ], {}),
        ("signal_audits", [ ("user_id", 1), ("recorded_at", -1) ], {}),
        ("market_data_provenance", [ ("instrument_key", 1), ("recorded_at", -1) ], {}),
