...
def normalize_order_row(row: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "price": row.get("price"),
        "gross_pnl": row.get("gross_pnl") or row.get("gross_realized_pnl") or row.get("realized_pnl") or row.get("pnl"),
        "charges": row.get("charges") if row.get("charges") is not None else row.get("brokerage"),
        "net_pnl": row.get("net_pnl") if row.get("net_pnl") is not None else row.get("realized_pnl") or row.get("pnl"),
