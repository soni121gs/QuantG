...
- `[ ]` **IA-7** *(DEFERRED — infra, low urgency)* RAG over wiki+lessons for Hermes. Anti-drift value only matters once the miner (IA-6) runs. Reuses existing embeddings path.
