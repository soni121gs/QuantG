...
- `[ ]` **IA-8** *(DEFERRED — surface real signals only)* Telemetry/UI. Nothing validated to surface yet (OI dead, skew marginal). Add a FII/DII flow panel once IA-4 accumulates enough forward days to be worth showing. Mirror the RegimeOOS panel then.
